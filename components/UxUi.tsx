        ...
        <div className='py-20' id='uxui'>
            ...
            <div className='flex flex-wrap items-center justify-center p-4 gap-x-24 gap-y-8 mt-10'>
                {uxui.map(({ id,
                    ...
                    iconLists,
                    link }) => (
                    <div key={id} className='sm:h-[41rem] lg:min-h-[32.5rem] h-[25rem] flex items-center justify-center sm:w-[570px] w-[80vw]'>
            ...
            <a href='/Assests/uxui_ruthvik.pdf' className='flex justify-center items-center relative m-4'>
                <MagicButton
